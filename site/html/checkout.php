...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Syncopate:wght@700&family=Inter:wght@400;500;700;900&display=swap" rel="stylesheet">
    <style>
            ...
            <div class="glass rounded-3xl p-6">
                ...
                <form action="#" method="POST" class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 outline-none focus:border-blue-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="email" class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 outline-none focus:border-blue-500">
                    </div>
                    ...
                    <div class="md:col-span-2 pt-4">
                        <button type="button" class="w-full bg-blue-600 hover:bg-blue-500 transition rounded-2xl py-4 font-black uppercase">
